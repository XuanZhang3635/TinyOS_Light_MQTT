...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c01458, const void *arg_0xb7c015f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bb28c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a5c840), 
int (*key_eq_fn)(void *arg_0xb7a5cc88, void *arg_0xb7a5ce00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb792b9b8, int arg_0xb792bb10);
static double RandomUniform(void );
...
# 79 "/opt/tinyos-main-2.1.2/tos/lib/printf/printf.h"
#line 77
...
typedef TMilli NodeC$SendTimer$precision_tag;
typedef TMilli NodeC$TimerHum$precision_tag;
typedef TMilli NodeC$TimerTemp$precision_tag;
typedef TMilli NodeC$ConnectTimeoutTimer$precision_tag;
typedef TMilli NodeC$SubscribeTimeoutTimer$precision_tag;
typedef TMilli NodeC$TimerLum$precision_tag;
...
static void NodeC$SendTimer$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void NodeC$AMControl$startDone(error_t error);
#line 138
static void NodeC$AMControl$stopDone(error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$TimerHum$fired(void );
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void NodeC$Boot$booted(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$TimerTemp$fired(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void NodeC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void NodeC$sendTask$runTask(void );
#line 75
static void NodeC$connectionHandler$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$ConnectTimeoutTimer$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$SubscribeTimeoutTimer$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void NodeC$publishHandler$runTask(void );
#line 75
static void NodeC$connackHandler$runTask(void );
#line 75
static void NodeC$subscriptionHandler$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$TimerLum$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void NodeC$subackHandler$runTask(void );
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
/*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(
#line 132
message_t * msg, 
...
static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool NodeC$SendTimer$isRunning(void );
#line 73
static void NodeC$SendTimer$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t NodeC$AMControl$start(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$TimerHum$startPeriodic(uint32_t dt);
#line 64
static void NodeC$TimerTemp$startPeriodic(uint32_t dt);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t NodeC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t NodeC$Random$rand16(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t NodeC$sendTask$postTask(void );
#line 67
static error_t NodeC$connectionHandler$postTask(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$ConnectTimeoutTimer$startOneShot(uint32_t dt);




static void NodeC$ConnectTimeoutTimer$stop(void );
#line 73
static void NodeC$SubscribeTimeoutTimer$startOneShot(uint32_t dt);




static void NodeC$SubscribeTimeoutTimer$stop(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t NodeC$publishHandler$postTask(void );
#line 67
static error_t NodeC$connackHandler$postTask(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t NodeC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool NodeC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t NodeC$subscriptionHandler$postTask(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodeC$TimerLum$startPeriodic(uint32_t dt);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t NodeC$subackHandler$postTask(void );
# 300 "NodeC.nc"
enum NodeC$__nesc_unnamed4334 {
#line 300
  NodeC$sendTask = 3U
};
#line 300
typedef int NodeC$__nesc_sillytask_sendTask[NodeC$sendTask];
#line 335
enum NodeC$__nesc_unnamed4335 {
#line 335
  NodeC$connectionHandler = 4U
};
#line 335
typedef int NodeC$__nesc_sillytask_connectionHandler[NodeC$connectionHandler];
#line 354
enum NodeC$__nesc_unnamed4336 {
#line 354
  NodeC$subscriptionHandler = 5U
};
#line 354
typedef int NodeC$__nesc_sillytask_subscriptionHandler[NodeC$subscriptionHandler];
#line 384
enum NodeC$__nesc_unnamed4337 {
#line 384
  NodeC$publishHandler = 6U
};
#line 384
typedef int NodeC$__nesc_sillytask_publishHandler[NodeC$publishHandler];
#line 438
enum NodeC$__nesc_unnamed4338 {
#line 438
  NodeC$connackHandler = 7U
};
#line 438
typedef int NodeC$__nesc_sillytask_connackHandler[NodeC$connackHandler];
#line 457
enum NodeC$__nesc_unnamed4339 {
#line 457
  NodeC$subackHandler = 8U
};
#line 457
typedef int NodeC$__nesc_sillytask_subackHandler[NodeC$subackHandler];
#line 35
uint8_t NodeC$state[1000];


void *NodeC$conPayload[1000];
void *NodeC$pubPayload[1000];
void *NodeC$subPayload[1000];
void *NodeC$connackPayload[1000];
void *NodeC$subackPayload[1000];



bool NodeC$connected_nodes[1000][8];
bool NodeC$topic_subs[1000][3][8];
uint8_t NodeC$idProcessed[1000][8];



uint8_t NodeC$pubTopic[1000];
uint8_t NodeC$subscriptions[1000][4];


message_t NodeC$buffer[1000][150];
am_addr_t NodeC$dest_addr[1000][150];
uint8_t NodeC$length[1000][150];
uint8_t NodeC$head[1000];
uint8_t NodeC$tail[1000];
uint8_t NodeC$msgId[1000];
bool NodeC$lock[1000];
bool NodeC$full[1000];




static inline error_t NodeC$addConnect(void );
#line 102
static inline error_t NodeC$addConnack(uint8_t dest);
#line 139
static inline error_t NodeC$addSubscribe(uint8_t *args);
#line 177
static inline error_t NodeC$addSuback(uint8_t dest);
#line 213
static error_t NodeC$addPublish(uint8_t *args);
#line 250
static void NodeC$connect(void );
#line 266
static void NodeC$subscribe(void );
#line 283
static void NodeC$publish(uint16_t value);
#line 300
static inline void NodeC$sendTask$runTask(void );
#line 335
static inline void NodeC$connectionHandler$runTask(void );
#line 354
static inline void NodeC$subscriptionHandler$runTask(void );
#line 384
static inline void NodeC$publishHandler$runTask(void );
#line 438
static inline void NodeC$connackHandler$runTask(void );
#line 457
static inline void NodeC$subackHandler$runTask(void );
#line 471
static inline void NodeC$Boot$booted(void );
#line 522
static inline void NodeC$AMControl$startDone(error_t err);
#line 537
static inline void NodeC$AMControl$stopDone(error_t err);


static inline void NodeC$SendTimer$fired(void );
...
static inline void NodeC$TimerTemp$fired(void );
...
static inline void NodeC$TimerHum$fired(void );
...
static inline void NodeC$TimerLum$fired(void );





static void NodeC$AMSend$sendDone(message_t *buf, error_t err);
#line 610
static inline message_t *NodeC$Receive$receive(message_t *buffer, void *payload, uint8_t len);
#line 686
static inline void NodeC$ConnectTimeoutTimer$fired(void );
...
static inline void NodeC$SubscribeTimeoutTimer$fired(void );
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
/*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(
#line 122
message_t * msg, 
...
static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
...
static inline void */*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(message_t *m, uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t NodeC$subackHandler$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(NodeC$subackHandler);
#line 67
...
#line 67
inline static error_t NodeC$connackHandler$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(NodeC$connackHandler);
#line 67
...
#line 67
inline static error_t NodeC$publishHandler$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(NodeC$publishHandler);
#line 67
...
#line 67
inline static error_t NodeC$subscriptionHandler$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(NodeC$subscriptionHandler);
#line 67
...
#line 67
inline static error_t NodeC$connectionHandler$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(NodeC$connectionHandler);
#line 67
...
#line 610
{
  ...
  sim_log_debug(193U, "debug", "============ Receiving ============\n");

  if (TOS_NODE_ID == 1) {

      sim_log_debug(194U, "node", "the broker receives a message...\n");

      switch (len) {

          case sizeof(ConnectMessage ): 

            NodeC$conPayload[sim_node()] = payload;
          NodeC$connectionHandler$postTask();
          break;

          case sizeof(SubscribeMessage ): 

            NodeC$subPayload[sim_node()] = payload;
          NodeC$subscriptionHandler$postTask();
          break;

          case sizeof(PublishMessage ): 

            NodeC$pubPayload[sim_node()] = payload;
          NodeC$publishHandler$postTask();
          break;
        }
    }
  else 
    {
      ...
      sim_log_debug(195U, "node", "[NODE %d] receives a message...\n", TOS_NODE_ID);
      ...
      if (len == sizeof(AckMessage )) {
          ...
          switch (__nesc_ntoh_uint8(ackMsg->code.nxdata)) {
              ...
              case 2: 
                ...
                NodeC$connackPayload[sim_node()] = payload;
              NodeC$connackHandler$postTask();
              break;

              case 4: 

                NodeC$subackPayload[sim_node()] = payload;
              NodeC$subackHandler$postTask();
              break;
            }
        }
      else {
#line 663
        if (len == sizeof(PublishMessage )) {
            ...
            pubMsg = (PublishMessage *)NodeC$pubPayload[sim_node()];
            topic = __nesc_ntoh_uint8(pubMsg->topicID.nxdata);

            sim_log_debug(196U, "node", "[NODE %u] Received MESSAGE [Topic: %s | QoS: %u |Payload: %u]\n", TOS_NODE_ID, topic == 0 ? "TEMP" : topic == 1 ? "HUM" : "LUM", NodeC$subscriptions[sim_node()][2 * topic + 1], payload);
          }
        else 
          {

            sim_log_debug(197U, "error", "[ERROR] INVALID PACKET\n");
          }
        }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7690298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7690298) {
#line 78
    case 6:
#line 78
      __nesc_result = NodeC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7690298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7690930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7690930, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t NodeC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 522
{
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
        sim_log_debug(188U, "comm", "[BROKER] Radio on!\n");
        }
      else {
#line 528
        sim_log_debug(189U, "comm", "[NODE %u] Radio on!\n", TOS_NODE_ID);
        }
    }
  else 
#line 530
...
#line 113
  NodeC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  NodeC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76a18b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76a18b0, msg, error);
#line 110
}
#line 110
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodeC$SendTimer$startOneShot(uint32_t dt){
#line 73
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool NodeC$SendTimer$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74ad730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74ad730, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(198U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(199U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(200U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(201U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t NodeC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t NodeC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 300
{
  ...
  message_t *p = &NodeC$buffer[sim_node()][NodeC$head[sim_node()]];

  if (!NodeC$lock[sim_node()] && !NodeC$full[sim_node()]) {
      NodeC$lock[sim_node()] = TRUE;


      if (NodeC$length[sim_node()][NodeC$head[sim_node()]] == sizeof(ConnectMessage ) || NodeC$length[sim_node()][NodeC$head[sim_node()]] == sizeof(SubscribeMessage )) {

          NodeC$PacketAcknowledgements$requestAck(p);
        }

      if (NodeC$AMSend$send(NodeC$dest_addr[sim_node()][NodeC$head[sim_node()]], p, NodeC$length[sim_node()][NodeC$head[sim_node()]]) == SUCCESS) {
          NodeC$full[sim_node()] = FALSE;
          sim_log_debug(171U, "debug", "[NODE %u]   SENDING message to %d from queue position %d SUCCESS\n", TOS_NODE_ID, NodeC$dest_addr[sim_node()][NodeC$head[sim_node()]], NodeC$head[sim_node()]);
        }
      else 
#line 316
        {
          sim_log_debug(172U, "debug", "[NODE %u]   SENDING message to %d from queue position %d FAILED\n", TOS_NODE_ID, NodeC$dest_addr[sim_node()][NodeC$head[sim_node()]], NodeC$head[sim_node()]);
        }
    }



  if (NodeC$head[sim_node()] != NodeC$tail[sim_node()] && !NodeC$SendTimer$isRunning()) {
      NodeC$SendTimer$startOneShot(1000);
    }
}

# 135 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$getPayload(am_id_t arg_0xb74ad730, message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = TossimActiveMessageC$AMSend$getPayload(arg_0xb74ad730, msg, len);
#line 135
...
inline static void * /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(message_t * msg, uint8_t len){
#line 125
  void *__nesc_result;
#line 125
...
#line 73
{
  return /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(m, len);
}

# 135 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void * NodeC$AMSend$getPayload(message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135

#line 135
  __nesc_result = /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(msg, len);
#line 135
...
#line 102
{
  ...
  sim_log_debug(151U, "debug", "[NODE %u] ADD CONNACK. head: %u, tail:%u\n", TOS_NODE_ID, NodeC$head[sim_node()], NodeC$tail[sim_node()]);

  if (!NodeC$full[sim_node()]) {
      AckMessage *ackMsg;

#line 108
      ackMsg = (AckMessage *)NodeC$AMSend$getPayload(&NodeC$buffer[sim_node()][NodeC$tail[sim_node()]], sizeof(AckMessage ));

      __nesc_hton_uint8(ackMsg->clientID.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(ackMsg->ID.nxdata, NodeC$msgId[sim_node()]);
      __nesc_hton_uint8(ackMsg->code.nxdata, 2);

      NodeC$msgId[sim_node()] += 1;

      sim_log_debug(152U, "debug", "CONTENT IN CONNACK: %u %u %u\n", __nesc_ntoh_uint8(ackMsg->ID.nxdata), __nesc_ntoh_uint8(ackMsg->clientID.nxdata), __nesc_ntoh_uint8(ackMsg->code.nxdata));
      sim_log_debug(153U, "debug", "DEST of CONNACK is: %d\n", dest);
      NodeC$dest_addr[sim_node()][NodeC$tail[sim_node()]] = dest;
      NodeC$length[sim_node()][NodeC$tail[sim_node()]] = sizeof(AckMessage );
      NodeC$tail[sim_node()] = (NodeC$tail[sim_node()] + 1) % 150;

      if (NodeC$tail[sim_node()] == NodeC$head[sim_node()]) {
          NodeC$full[sim_node()] = TRUE;
        }

      if (!NodeC$SendTimer$isRunning()) {
          sim_log_debug(154U, "debug", "start CONNACK Timer...\n");
          NodeC$SendTimer$startOneShot(1000);
        }
...
#line 132
    {
      sim_log_debug(155U, "error", "[ERROR] QUEUE IS FULL: could not put message on queue\n");
    }
  return FAIL;
}
...
#line 339
  conMsg = (ConnectMessage *)NodeC$conPayload[sim_node()];
  sim_log_debug(173U, "node", "[BROKER] Received CONNECT [Src: %u]\n", __nesc_ntoh_uint8(conMsg->clientID.nxdata));

  if (NodeC$addConnack(__nesc_ntoh_uint8(conMsg->clientID.nxdata)) == SUCCESS) {
      sim_log_debug(174U, "node", "[BROKER] Enqueuing CONNACK to %u\n", __nesc_ntoh_uint8(conMsg->clientID.nxdata));
    }

  NodeC$connected_nodes[sim_node()][__nesc_ntoh_uint8(conMsg->clientID.nxdata) - 2] = 1;

  for (i = 0; i < 8; i++) {
      sim_log_debug(175U, "debug", "[BROKER] Node %d connecting state: %d\n", i + 2, NodeC$connected_nodes[sim_node()][i]);
    }
}
...
#line 177
{
  ...
  sim_log_debug(159U, "debug", "[NODE %u] ADD SUBACK. head: %u, tail:%u\n", TOS_NODE_ID, NodeC$head[sim_node()], NodeC$tail[sim_node()]);
...
#line 183
      ...
      sim_log_debug(160U, "debug", "CONTENT IN SUBACK: %u %u %u\n", __nesc_ntoh_uint8(ackMsg->ID.nxdata), __nesc_ntoh_uint8(ackMsg->clientID.nxdata), __nesc_ntoh_uint8(ackMsg->code.nxdata));
      sim_log_debug(161U, "node", "DEST of SUBACK is %d\n", dest);
      NodeC$dest_addr[sim_node()][NodeC$tail[sim_node()]] = dest;
      NodeC$length[sim_node()][NodeC$tail[sim_node()]] = sizeof(AckMessage );
      NodeC$tail[sim_node()] = (NodeC$tail[sim_node()] + 1) % 150;
...
#line 206
    {
      sim_log_debug(162U, "error", "[ERROR] QUEUE IS FULL: could not put message on queue\n");
    }
  return FAIL;
}
...
#line 358
  subMsg = (SubscribeMessage *)NodeC$subPayload[sim_node()];
  sim_log_debug(176U, "node", "[BROKER] Received SUBSCRIBE [Src: %u]\n", __nesc_ntoh_uint8(subMsg->clientID.nxdata));

  if (__nesc_ntoh_uint8(subMsg->topic1.nxdata)) {

      sim_log_debug(177U, "node", "[BROKER] Subscribing node %d to topic \"TEMPERATURE\"\n", __nesc_ntoh_uint8(subMsg->clientID.nxdata));
      NodeC$topic_subs[sim_node()][0][__nesc_ntoh_uint8(subMsg->clientID.nxdata) - 2] = 1;
    }
  else {
#line 366
    if (__nesc_ntoh_uint8(subMsg->topic2.nxdata)) {

        sim_log_debug(178U, "node", "[BROKER] Subscribing node %d to topic \"HUMIDITY\"\n", __nesc_ntoh_uint8(subMsg->clientID.nxdata));
        NodeC$topic_subs[sim_node()][1][__nesc_ntoh_uint8(subMsg->clientID.nxdata) - 2] = 1;
      }
    else {
#line 371
      if (__nesc_ntoh_uint8(subMsg->topic3.nxdata)) {

          sim_log_debug(179U, "node", "[BROKER] Subscribing node %d to topic \"LUMINOSITY\"\n", __nesc_ntoh_uint8(subMsg->clientID.nxdata));
          NodeC$topic_subs[sim_node()][2][__nesc_ntoh_uint8(subMsg->clientID.nxdata) - 2] = 1;
        }
      }
    }
  if (NodeC$addSuback(__nesc_ntoh_uint8(subMsg->clientID.nxdata)) == SUCCESS) {
      sim_log_debug(180U, "node", "[BROKER] Enqueuing SUBACK to %u\n", __nesc_ntoh_uint8(subMsg->clientID.nxdata));
    }
}
...
#line 384
{
  ...
  if (TOS_NODE_ID == 1) {
      ...
      if (__nesc_ntoh_uint8(pubMsg->ID.nxdata) != NodeC$idProcessed[sim_node()][__nesc_ntoh_uint8(pubMsg->clientID.nxdata) - 2]) {

          NodeC$idProcessed[sim_node()][__nesc_ntoh_uint8(pubMsg->clientID.nxdata) - 2] = __nesc_ntoh_uint8(pubMsg->ID.nxdata);
          ...
          sim_log_debug(181U, "node", "[BROKER] Received PUBLISH [Src: %u | Topic: %s | QoS: %u | Payload: %d]\n", client, args[0] == 0 ? "TEMP" : args[0] == 1 ? "HUM" : "LUM", __nesc_ntoh_uint8(pubMsg->qos.nxdata), args[1]);
          ...
          for (n = 0; n < 8; n++) {
              ...
              if (n + 2 != client && NodeC$connected_nodes[sim_node()][n] && NodeC$topic_subs[sim_node()][args[0]][n]) {

                  args[2] = 0;
                  args[3] = n + 2;

                  if (NodeC$addPublish(args) == SUCCESS) {
                      sim_log_debug(182U, "node", "[BROKER] Enqueuing PUBLISH [Dest: %u | Topic: %s | QoS: %u | Payload: %u]\n", n + 2, args[0] == 0 ? "TEMP" : args[0] == 1 ? "HUM" : "LUM", args[2], args[1]);
                    }
                  else {
                      sim_log_debug(183U, "error", "[ERROR] PUBLISH enqueuing failed!\n");
                    }
                }
            }
        }
...
inline static void NodeC$ConnectTimeoutTimer$stop(void ){
#line 78
...
#line 438
{
  ...
  AckMessage *ackm = (AckMessage *)NodeC$connackPayload[sim_node()];

  sim_log_debug(184U, "node", "[NODE %u] Received CONNACK [Src: %u]\n", TOS_NODE_ID, __nesc_ntoh_uint8(ackm->clientID.nxdata));

  NodeC$state[sim_node()] = 1;

  NodeC$ConnectTimeoutTimer$stop();



  if ((NodeC$subscriptions[sim_node()][0] || NodeC$subscriptions[sim_node()][1]) || NodeC$subscriptions[sim_node()][2]) {
    NodeC$subscribe();
    }
}

# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodeC$SubscribeTimeoutTimer$stop(void ){
#line 78
...
#line 457
{
  ...
  AckMessage *ackm = (AckMessage *)NodeC$subackPayload[sim_node()];

  sim_log_debug(185U, "node", "[NODE %u] Received SUBACK [Src: %u]\n", TOS_NODE_ID, __nesc_ntoh_uint8(ackm->clientID.nxdata));

  NodeC$state[sim_node()] = 2;

  NodeC$SubscribeTimeoutTimer$stop();
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  NodeC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74b0ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74b0ca8) {
#line 100
    case 0U:
#line 100
      /*NodeAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74b0ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7887650){
#line 75
  switch (arg_0xb7887650) {
#line 75
...
#line 75
    case NodeC$sendTask:
#line 75
      NodeC$sendTask$runTask();
#line 75
      break;
#line 75
    case NodeC$connectionHandler:
#line 75
      NodeC$connectionHandler$runTask();
#line 75
      break;
#line 75
    case NodeC$subscriptionHandler:
#line 75
      NodeC$subscriptionHandler$runTask();
#line 75
      break;
#line 75
    case NodeC$publishHandler:
#line 75
      NodeC$publishHandler$runTask();
#line 75
      break;
#line 75
    case NodeC$connackHandler:
#line 75
      NodeC$connackHandler$runTask();
#line 75
      break;
#line 75
    case NodeC$subackHandler:
#line 75
      NodeC$subackHandler$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7887650);
#line 75
      break;
#line 75
    }
...
#line 694
{
  ...
  if (NodeC$state[sim_node()] == 1) {
    NodeC$subscribe();
    }
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t NodeC$sendTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(NodeC$sendTask);
#line 67
...
#line 540
{
  if (NodeC$head[sim_node()] != NodeC$tail[sim_node()]) {
      NodeC$sendTask$postTask();
    }
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t NodeC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
{
  if (NodeC$state[sim_node()] >= 1) {
      NodeC$publish(NodeC$Random$rand16() % 60);
    }
}
...
{
  if (NodeC$state[sim_node()] >= 1) {
      NodeC$publish(NodeC$Random$rand16() % 100);
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb732fc70){
#line 83
  switch (arg_0xb732fc70) {
#line 83
    case 0U:
#line 83
      NodeC$ConnectTimeoutTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      NodeC$SubscribeTimeoutTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      NodeC$SendTimer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      NodeC$TimerTemp$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      NodeC$TimerHum$fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      NodeC$TimerLum$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb732fc70);
#line 83
      break;
#line 83
    }
...
#line 139
{
  ...
  sim_log_debug(156U, "debug", "[NODE %u] ADD SUBSCRIBE. head: %u, tail:%u\n", TOS_NODE_ID, NodeC$head[sim_node()], NodeC$tail[sim_node()]);

  if (!NodeC$full[sim_node()]) {
      SubscribeMessage *subMsg;

#line 145
      subMsg = (SubscribeMessage *)NodeC$AMSend$getPayload(&NodeC$buffer[sim_node()][NodeC$tail[sim_node()]], sizeof(SubscribeMessage ));

      __nesc_hton_uint8(subMsg->ID.nxdata, NodeC$msgId[sim_node()]);
      ...
      sim_log_debug(157U, "debug", "CONTENT IN SUBSCRIBE: %u %u %u\n", __nesc_ntoh_uint8(subMsg->ID.nxdata), __nesc_ntoh_uint8(subMsg->clientID.nxdata));
      NodeC$dest_addr[sim_node()][NodeC$tail[sim_node()]] = 1;
      NodeC$length[sim_node()][NodeC$tail[sim_node()]] = sizeof(SubscribeMessage );
      NodeC$tail[sim_node()] = (NodeC$tail[sim_node()] + 1) % 150;
...
#line 170
    {
      sim_log_debug(158U, "error", "[ERROR] QUEUE IS FULL: could not put message on queue\n");
    }
  return FAIL;
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodeC$SubscribeTimeoutTimer$startOneShot(uint32_t dt){
#line 73
...
#line 68
{
  ...
  sim_log_debug(148U, "debug", "[NODE %u] ADD CONNECT. head: %u, tail:%u\n", TOS_NODE_ID, NodeC$head[sim_node()], NodeC$tail[sim_node()]);

  if (!NodeC$full[sim_node()]) {
      ConnectMessage *conMsg;

#line 74
      conMsg = (ConnectMessage *)NodeC$AMSend$getPayload(&NodeC$buffer[sim_node()][NodeC$tail[sim_node()]], sizeof(ConnectMessage ));

      __nesc_hton_uint8(conMsg->clientID.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(conMsg->ID.nxdata, NodeC$msgId[sim_node()]);

      NodeC$msgId[sim_node()] += 1;

      sim_log_debug(149U, "debug", "CONTENT IN node CONNECT: %u %u\n", __nesc_ntoh_uint8(conMsg->ID.nxdata), __nesc_ntoh_uint8(conMsg->clientID.nxdata));
      NodeC$dest_addr[sim_node()][NodeC$tail[sim_node()]] = 1;
      NodeC$length[sim_node()][NodeC$tail[sim_node()]] = sizeof(ConnectMessage );
      NodeC$tail[sim_node()] = (NodeC$tail[sim_node()] + 1) % 150;
...
#line 95
    {
      sim_log_debug(150U, "error", "[ERROR] QUEUE IS FULL: could not put message on queue\n");
    }
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodeC$ConnectTimeoutTimer$startOneShot(uint32_t dt){
#line 73
...
#line 577
{
  sim_log_debug(229U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(228U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(225U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(226U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(218U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(208U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(215U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
inline static bool NodeC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 364
{
  sim_log_debug(220U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 62
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodeC$TimerLum$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(5U, dt);
#line 64
}
#line 64
inline static void NodeC$TimerHum$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(4U, dt);
#line 64
}
#line 64
inline static void NodeC$TimerTemp$startPeriodic(uint32_t dt){
#line 64
...
#line 471
{
  ...
  if (TOS_NODE_ID == 1) {
      ...
      for (c = 0; c < 8; c++) 
        NodeC$idProcessed[sim_node()][c] = 0;

      sim_log_debug(186U, "boot", "[BROKER] Application booted.\n");

      NodeC$state[sim_node()] = 2;
    }
  else {

      sim_log_debug(187U, "boot", "[NODE %u] Application booted.\n", TOS_NODE_ID);

      NodeC$state[sim_node()] = 0;


      NodeC$pubTopic[sim_node()] = PUBLICATION_TOPIC[TOS_NODE_ID - 2];
      NodeC$subscriptions[sim_node()][0] = SUBSCRIPTIONS_TOPIC[0][TOS_NODE_ID - 2];
      NodeC$subscriptions[sim_node()][1] = SUBSCRIPTIONS_TOPIC[1][TOS_NODE_ID - 2];
      NodeC$subscriptions[sim_node()][2] = SUBSCRIPTIONS_TOPIC[2][TOS_NODE_ID - 2];
      NodeC$subscriptions[sim_node()][3] = 0;


      if (NodeC$pubTopic[sim_node()] == 0) {
          NodeC$TimerTemp$startPeriodic(6000);
        }
      else {
#line 500
        if (NodeC$pubTopic[sim_node()] == 1) {
            NodeC$TimerHum$startPeriodic(14000);
          }
        else {
#line 502
          if (NodeC$pubTopic[sim_node()] == 2) {
              NodeC$TimerLum$startPeriodic(8000);
            }
          }
        }
      NodeC$connect();
  ...
  NodeC$lock[sim_node()] = FALSE;
  NodeC$head[sim_node()] = 0;
  NodeC$tail[sim_node()] = 0;
  NodeC$msgId[sim_node()] = 1;
  NodeC$full[sim_node()] = FALSE;
...
#line 285
  ...
  sim_log_debug(217U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(223U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 283
{
  ...
  uint8_t args[4] = { NodeC$pubTopic[sim_node()], value, 0, 1 };

  if (NodeC$addPublish(args) == SUCCESS) {

      sim_log_debug(170U, "node", "[NODE %u] Enqueuing PUBLISH [Topic: %s | Payload: %u]\n", TOS_NODE_ID, args[0] == 0 ? "TEMP" : args[0] == 1 ? "HUM" : "LUM", args[1]);
    }
}
...
#line 213
{
  ...
  sim_log_debug(163U, "debug", "[NODE %u] ADD PUBLISH. head: %u, tail:%u\n", TOS_NODE_ID, NodeC$head[sim_node()], NodeC$tail[sim_node()]);

  if (!NodeC$full[sim_node()]) {
      PublishMessage *pubMsg;

#line 219
      pubMsg = (PublishMessage *)NodeC$AMSend$getPayload(&NodeC$buffer[sim_node()][NodeC$tail[sim_node()]], sizeof(PublishMessage ));

      __nesc_hton_uint8(pubMsg->ID.nxdata, NodeC$msgId[sim_node()]);
      ...
      sim_log_debug(164U, "debug", "CONTENT IN PUBLISH: %u %u %u\n", __nesc_ntoh_uint8(pubMsg->ID.nxdata), __nesc_ntoh_uint8(pubMsg->clientID.nxdata));

      NodeC$dest_addr[sim_node()][NodeC$tail[sim_node()]] = args[3];
      NodeC$length[sim_node()][NodeC$tail[sim_node()]] = sizeof(PublishMessage );
      NodeC$tail[sim_node()] = (NodeC$tail[sim_node()] + 1) % 150;
...
#line 244
    {
      sim_log_debug(165U, "error", "[ERROR] QUEUE IS FULL: could not put message on queue\n");
    }
  return FAIL;
}

# 95 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimActiveMessageC.nc"
static void *TossimActiveMessageC$AMSend$getPayload(am_id_t id, message_t *m, uint8_t len)
#line 95
{
...
#line 266
{
  ...
  if (NodeC$addSubscribe(NodeC$subscriptions[sim_node()]) == SUCCESS) {

      sim_log_debug(168U, "node", "[NODE %u] SUBSCRIBE requested to the BROKER\n", TOS_NODE_ID);
    }
  else {

      sim_log_debug(169U, "error", "[ERROR] SUBSCRIBE request failed!\n");
    }


  NodeC$SubscribeTimeoutTimer$startOneShot(20000);
}
...
#line 250
{
  ...
  if (NodeC$addConnect() == SUCCESS) {

      sim_log_debug(166U, "node", "[NODE %u] sends CONNECT request to the BROKER \n", TOS_NODE_ID);
    }
  else {

      sim_log_debug(167U, "error", "[ERROR] sends CONNECT request failed!\n");
    }


  NodeC$ConnectTimeoutTimer$startOneShot(20000);
}
...
#line 101
      sim_log_debug(203U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(204U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(205U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(206U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(224U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(227U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(216U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 572
{
  ...
  if (&NodeC$buffer[sim_node()][NodeC$head[sim_node()]] == buf && err == SUCCESS) {


      if (NodeC$length[sim_node()][NodeC$head[sim_node()]] == sizeof(PublishMessage ) || NodeC$PacketAcknowledgements$wasAcked(buf)) {


          NodeC$head[sim_node()] = (NodeC$head[sim_node()] + 1) % 150;
          sim_log_debug(190U, "debug", "[NODE %u] SENT queue position %u. New head: %u\n", TOS_NODE_ID, NodeC$head[sim_node()] == 0 ? 150 - 1 : NodeC$head[sim_node()] - 1, NodeC$head[sim_node()]);
...
#line 588
        if (!NodeC$PacketAcknowledgements$wasAcked(buf)) {

            sim_log_debug(191U, "error", "[ERROR] Receiver node FAILED in receiving packet!\n");
          }
        }
    }
  else {

      sim_log_debug(192U, "error", "[ERROR] SEND FAILED \n");
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module NodeC */
  if (!strcmp(varname, "NodeC$state"))
  {
    *addr = (uintptr_t)&NodeC$state[__nesc_mote];
    *size = sizeof(NodeC$state[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$conPayload"))
  {
    *addr = (uintptr_t)&NodeC$conPayload[__nesc_mote];
    *size = sizeof(NodeC$conPayload[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$pubPayload"))
  {
    *addr = (uintptr_t)&NodeC$pubPayload[__nesc_mote];
    *size = sizeof(NodeC$pubPayload[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$subPayload"))
  {
    *addr = (uintptr_t)&NodeC$subPayload[__nesc_mote];
    *size = sizeof(NodeC$subPayload[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$connackPayload"))
  {
    *addr = (uintptr_t)&NodeC$connackPayload[__nesc_mote];
    *size = sizeof(NodeC$connackPayload[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$subackPayload"))
  {
    *addr = (uintptr_t)&NodeC$subackPayload[__nesc_mote];
    *size = sizeof(NodeC$subackPayload[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$connected_nodes"))
  {
    *addr = (uintptr_t)&NodeC$connected_nodes[__nesc_mote];
    *size = sizeof(NodeC$connected_nodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$topic_subs"))
  {
    *addr = (uintptr_t)&NodeC$topic_subs[__nesc_mote];
    *size = sizeof(NodeC$topic_subs[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$idProcessed"))
  {
    *addr = (uintptr_t)&NodeC$idProcessed[__nesc_mote];
    *size = sizeof(NodeC$idProcessed[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$pubTopic"))
  {
    *addr = (uintptr_t)&NodeC$pubTopic[__nesc_mote];
    *size = sizeof(NodeC$pubTopic[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$subscriptions"))
  {
    *addr = (uintptr_t)&NodeC$subscriptions[__nesc_mote];
    *size = sizeof(NodeC$subscriptions[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$buffer"))
  {
    *addr = (uintptr_t)&NodeC$buffer[__nesc_mote];
    *size = sizeof(NodeC$buffer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$dest_addr"))
  {
    *addr = (uintptr_t)&NodeC$dest_addr[__nesc_mote];
    *size = sizeof(NodeC$dest_addr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$length"))
  {
    *addr = (uintptr_t)&NodeC$length[__nesc_mote];
    *size = sizeof(NodeC$length[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$head"))
  {
    *addr = (uintptr_t)&NodeC$head[__nesc_mote];
    *size = sizeof(NodeC$head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$tail"))
  {
    *addr = (uintptr_t)&NodeC$tail[__nesc_mote];
    *size = sizeof(NodeC$tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$msgId"))
  {
    *addr = (uintptr_t)&NodeC$msgId[__nesc_mote];
    *size = sizeof(NodeC$msgId[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$lock"))
  {
    *addr = (uintptr_t)&NodeC$lock[__nesc_mote];
    *size = sizeof(NodeC$lock[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodeC$full"))
  {
    *addr = (uintptr_t)&NodeC$full[__nesc_mote];
    *size = sizeof(NodeC$full[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module NodeC */
  NodeC$state[__nesc_mote] = 0;
  memset((void *)&NodeC$conPayload[__nesc_mote], 0, sizeof NodeC$conPayload[__nesc_mote]);
  memset((void *)&NodeC$pubPayload[__nesc_mote], 0, sizeof NodeC$pubPayload[__nesc_mote]);
  memset((void *)&NodeC$subPayload[__nesc_mote], 0, sizeof NodeC$subPayload[__nesc_mote]);
  memset((void *)&NodeC$connackPayload[__nesc_mote], 0, sizeof NodeC$connackPayload[__nesc_mote]);
  memset((void *)&NodeC$subackPayload[__nesc_mote], 0, sizeof NodeC$subackPayload[__nesc_mote]);
  memset((void *)&NodeC$connected_nodes[__nesc_mote], 0, sizeof NodeC$connected_nodes[__nesc_mote]);
  memset((void *)&NodeC$topic_subs[__nesc_mote], 0, sizeof NodeC$topic_subs[__nesc_mote]);
  memset((void *)&NodeC$idProcessed[__nesc_mote], 0, sizeof NodeC$idProcessed[__nesc_mote]);
  memset((void *)&NodeC$pubTopic[__nesc_mote], 0, sizeof NodeC$pubTopic[__nesc_mote]);
  memset((void *)&NodeC$subscriptions[__nesc_mote], 0, sizeof NodeC$subscriptions[__nesc_mote]);
  memset((void *)&NodeC$buffer[__nesc_mote], 0, sizeof NodeC$buffer[__nesc_mote]);
  memset((void *)&NodeC$dest_addr[__nesc_mote], 0, sizeof NodeC$dest_addr[__nesc_mote]);
  memset((void *)&NodeC$length[__nesc_mote], 0, sizeof NodeC$length[__nesc_mote]);
  memset((void *)&NodeC$head[__nesc_mote], 0, sizeof NodeC$head[__nesc_mote]);
  memset((void *)&NodeC$tail[__nesc_mote], 0, sizeof NodeC$tail[__nesc_mote]);
  memset((void *)&NodeC$msgId[__nesc_mote], 0, sizeof NodeC$msgId[__nesc_mote]);
  memset((void *)&NodeC$lock[__nesc_mote], 0, sizeof NodeC$lock[__nesc_mote]);
  memset((void *)&NodeC$full[__nesc_mote], 0, sizeof NodeC$full[__nesc_mote]);
